...
// In ROS2 deployment we usually do NOT want libraries to auto-create/write config files at runtime.
// Define VC_DISABLE_AUTO_YML=1 to disable automatic load/write during static initialization.
