...
class RuneTarget : public FeatureNode
{
 ...
 public:
   ...
   */
  RuneTarget(const ContourConstPtr& CONTOUR, const std::vector<cv::Point2f>& CORNERS);
   ...
   */
  static inline std::shared_ptr<RuneTarget> Cast(const FeatureNodePtr& p_feature)
  {
   ...
   */
  static inline const std::shared_ptr<const RuneTarget> Cast(
   ...
   */
  static void FindInactiveTargets(
...
//! 神符靶心特征智能指针类型
using RuneTargetPtr = std::shared_ptr<RuneTarget>;  //!< 可修改的 RuneTarget 智能指针
using RuneTargetConstPtr =
