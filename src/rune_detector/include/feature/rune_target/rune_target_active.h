...
class RuneTargetActive : public RuneTarget
{
 ...
 public:
   ...
   */
  RuneTargetActive(const ContourConstPtr& contour,
...
//! 智能指针类型定义
using RuneTargetActivePtr = std::shared_ptr<RuneTargetActive>;             //!< 可修改指针
using RuneTargetActiveConstPtr = std::shared_ptr<const RuneTargetActive>;  //!< 只读指针
